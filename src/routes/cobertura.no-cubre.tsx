      ...
      <div className="mx-auto max-w-3xl px-4 pb-16">
        <div className="rounded-2xl border border-red-200 bg-red-50 p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-red-900">Aún no estás cubierto por tu aseguradora</h1>
              ...
              <p className="mt-2 text-red-800">Contáctate con tu aseguradora al 800 721 3344</p>
            </div>
          </div>
        </div>
